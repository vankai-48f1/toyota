...
class Google_Client {
	 ...
	 *
	 * @param array $config Google_Config or string for the ini file to load.
	 */
	 ...
	 *
	 * @param string $scope_or_scopes string|array e.g. "profile".
	 */
	 ...
	 *
	 * @param string $cache Psr\Cache\CacheItemPoolInterface .
	 */
   ...
   * @param array $cacheConfig .
	 ...
	 *
	 * @param string $http GuzzleHttp\ClientInterface .
	 */
	...
	/**
	 * Create User Refresh Credentials
	 *
	 * @param string $scope .
	 * @param string $refreshToken .
	 */
