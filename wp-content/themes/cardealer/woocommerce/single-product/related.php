...
if ( empty( $product ) || ! $product->exists() || ( isset( $car_dealer_options['show_related_products'] ) && 'no' === (string) $car_dealer_options['show_related_products'] ) ) {
	return;
}
...
if ( $products->have_posts() ) : ?>
	...
	<div class="related products">
		...
		<h2><?php esc_html__( 'Related Products', 'cardealer' ); ?></h2>
